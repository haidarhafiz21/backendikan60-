...
class _HomeAdminPageState extends State<HomeAdminPage> {
  ...
  Future<void> _fetchProducts() async {
    ...
    try {
      ...
      setState(() { _errorMessage = 'Gagal memuat produk: $e'; _isLoading = false; });
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text('Kategori: ${product.category}', style: const TextStyle(fontSize: 14)),
                                      Text('Harga: Rp ${product.price.toStringAsFixed(0)}', style: const TextStyle(fontSize: 14)),
